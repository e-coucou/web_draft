function mousePressed() {
    ...
    if ( ((frameCount-debounce) > 10) ) {
        ...
        if (btListe.isIn(mouseX,mouseY,mode)) { 
            clearButtons();
            btListe.setOn();
            mode=0;
            return;
        ...
        if (btZoom.isIn(mouseX,mouseY,mode)) { mode=2;clearButtons();btZoom.setOn(); return;}
        ...
        if (btInfo.isIn(mouseX,mouseY,mode)) { mode_prev = mode; mode = 4; clearButtons(); btInfo.setOn(); return }
